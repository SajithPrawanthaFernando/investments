...
export default function HeroVideo() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full h-[92vh] sm:h-[100vh] min-h-[600px] pt-24 flex items-center justify-center overflow-hidden bg-navy"
    >
      ...
      <div className="relative z-10 max-w-[1440px] w-full mx-auto px-6 md:px-12 mt-16 pointer-events-none">
        ...
        <div className="overflow-hidden pb-2">
          <h1
            ...
            className="text-[45px] md:text-6xl  font-bold text-white tracking-tight leading-[1.1] "
          >
            SRI LANKA’S MOST
          </h1>
        </div>
        ...
        <div className="overflow-hidden pb-6">
          <h1
            ...
            className="text-[45px] md:text-6xl  font-bold text-brand tracking-tight leading-[1.1] "
          >
            INVESTMENTS.
          </h1>
        </div>
